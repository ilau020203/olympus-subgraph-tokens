...
export function handleTransfer(event: Transfer): void {
    if(event.params.from==Bytes.fromHexString("0x31F8Cc382c9898b273eff4e0b7626a6987C846E8")){
      ...
      balanceAdded(event.params.value,false,event.block.timestamp,UniswapV2,"0xfDf12D1F85b5082877A6E070524f50F6c84FAa6b");
    ...
    { 
      ...
      balanceAdded(event.params.value,true,event.block.timestamp,UniswapV2,"0xfDf12D1F85b5082877A6E070524f50F6c84FAa6b");
