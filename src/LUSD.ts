...
export function handleTransfer(event: Transfer): void {
    if(event.params.from==Bytes.fromHexString("0x31F8Cc382c9898b273eff4e0b7626a6987C846E8")){
      ...
      balanceAdded(toDecimal(event.params.value,18),false,event.block.timestamp,LUSD_SUFFIX,"0x5f98805A4E8be255a32880FDeC7F6728C6568bA0");
    ...
    { 
      ...
      balanceAdded(toDecimal(event.params.value,18),true,event.block.timestamp,LUSD_SUFFIX,"0x5f98805A4E8be255a32880FDeC7F6728C6568bA0");
