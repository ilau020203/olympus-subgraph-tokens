...
export class UNI_V2__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class UNI_V2__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UNI_V2 extends ethereum.SmartContract {
  static bind(address: Address): UNI_V2 {
    return new UNI_V2("UNI_V2", address);
  }
  ...
  burn(to: Address): UNI_V2__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new UNI_V2__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<UNI_V2__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UNI_V2__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): UNI_V2__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new UNI_V2__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<UNI_V2__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
